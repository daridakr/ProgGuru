...
namespace Daridakr.ProgGuru.Migrations
{
    ...
    [Migration("20220308134509_Cms_Added0803")]
    partial class Cms_Added0803
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Daridakr.ProgGuru.Entities.Users.Skills.UserSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CommonUserSkills", (string)null);
                });
            ...
            modelBuilder.Entity("Daridakr.ProgGuru.Entities.Users.Skills.UserLanguageSkill", b =>
                {
                    b.HasBaseType("Daridakr.ProgGuru.Entities.Users.Skills.UserSkill");

                    b.Property<int>("LanguageLevel")
                        .HasColumnType("int");

                    b.ToTable("LanguageUserSkills", (string)null);
                });

            modelBuilder.Entity("Daridakr.ProgGuru.Entities.Users.Skills.UserProfSkill", b =>
                {
                    b.HasBaseType("Daridakr.ProgGuru.Entities.Users.Skills.UserSkill");
                    ...
                    b.Property<int>("KnownledgeLevel")
                        .HasColumnType("int");

                    b.HasIndex("GroupId");

                    b.ToTable("ProfUserSkills", (string)null);
                });
            ...
            modelBuilder.Entity("Daridakr.ProgGuru.Entities.Users.Skills.UserLanguageSkill", b =>
                {
                    b.HasOne("Daridakr.ProgGuru.Entities.Users.Skills.UserSkill", null)
                        .WithOne()
                        .HasForeignKey("Daridakr.ProgGuru.Entities.Users.Skills.UserLanguageSkill", "Id")
            ...
            modelBuilder.Entity("Daridakr.ProgGuru.Entities.Users.Skills.UserProfSkill", b =>
                {
                    ...
                    b.HasOne("Daridakr.ProgGuru.Entities.Users.Skills.UserSkill", null)
                        .WithOne()
                        .HasForeignKey("Daridakr.ProgGuru.Entities.Users.Skills.UserProfSkill", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
