$(document).ready(function () {
    ...
    // CREATE DATATABLE
    var dataTable = $('table#GroupSubscriptionsTable').DataTable({
        "language": {
    ...
    // PRINT TABLE
    const tableToPrint = document.getElementById('GroupSubscriptionsTable');
    ...
    function Popup(data) {
        const mywindow = window.open('', 'GroupSubscriptionsTable', 'height=600, width=1000');
