...
public partial class BlogPostAdminClientProxy : ClientProxyBase<IBlogPostAdminAppService>, IBlogPostAdminAppService
{
    ...
    public virtual async Task<bool> TryCreateAsync(CreateBlogPostDto input)
    {
        return await RequestAsync<bool>(nameof(TryCreateAsync), new ClientProxyRequestTypeValue
        {
            { typeof(CreateBlogPostDto), input }
        });
    }
    ...
    {
        return await RequestAsync<bool>(nameof(TryUpdateAsync), new ClientProxyRequestTypeValue
        {
            { typeof(Guid), id },
