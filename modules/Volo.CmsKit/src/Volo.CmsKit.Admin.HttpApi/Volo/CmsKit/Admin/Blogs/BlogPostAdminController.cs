...
public class BlogPostAdminController : CmsKitAdminController, IBlogPostAdminAppService
{
    ...
    public Task<bool> TryCreateAsync(CreateBlogPostDto input)
    {
        return BlogPostAdminAppService.TryCreateAsync(input);
    }

    public Task<bool> TryUpdateAsync(Guid id, UpdateBlogPostDto input)
    {
        return BlogPostAdminAppService.TryUpdateAsync(id, input);
    }
