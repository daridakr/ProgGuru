...
public class LanguageSwitchViewComponent : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        var progGuruLang = languages.Where(l => l.CultureName == "en" || l.CultureName == "ru");
        var currentLanguage = progGuruLang.FindByCulture(
        ...
        var model = new LanguageSwitchViewComponentModel
        {
            ...
            OtherLanguages = progGuruLang.Where(l => l != currentLanguage).ToList()
        };
